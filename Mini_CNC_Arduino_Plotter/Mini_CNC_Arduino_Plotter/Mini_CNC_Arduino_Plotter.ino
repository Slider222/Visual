...
//Stepper myStepperY(stepsPerRevolution, 20,21,22,23);            
//Stepper myStepperX(stepsPerRevolution, 6,27,25,26);  
//
...
//
      ...
      //case 0:  Serial.println("ishere");                                 // G00 & G01 - Movement or fast movement. Same here
      //case 1:
...
//Stepper myStepperY(stepsPerRevolution, 20,21,22,23);
//Stepper myStepperX(stepsPerRevolution, 6,27,25,26);
Stepper myStepperY(stepsPerRevolution, 0,1,2,3);
//Stepper myStepperX(stepsPerRevolution, 20,21,22,23);


void setup() {
	// Set speed:
	//DDRB |= (1 << PB2)|(1 << PB2)|(1 << PB3);
